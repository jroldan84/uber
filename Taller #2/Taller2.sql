...
CREATE UNIQUE INDEX PROFEAYUDENOS ON CONDUCTOR_VEHICULO(ID_CONDUCTOR);
...
--Punto 7.
CREATE OR REPLACE PROCEDURE CALCULAR_TARIFA(ID_SERVI NUMBER, DISTANCIA_SERVICIO NUMBER, TIEMPO_SERVICIO NUMBER,
...
BEGIN
	...
	WHERE A.ID_SERVICIO = ID_SERVI;
	SELECT VALOR_DISTANCIA( DISTANCIA_SERVICIO, CIUDAD_SERVICIO ) INTO VALOR_SERVICIO_DISTANCIA
	FROM DUAL;

	SELECT VALOR_TIEMPO( TIEMPO_SERVICIO, CIUDAD_SERVICIO ) INTO VALOR_SERVICIO_TIEMPO
	FROM DUAL;
