...
BEGIN
    ...
    IF ESTADO_SERVICIO = 'REALIZADO' THEN
        SELECT E.TARIFA_BASE,E.VALOR_MINUTO, E.VALOR_KILOMETRO ,E.CIUDAD INTO TARIFA_BASE1, VALOR_SERVICIO_TIEMPO,VALOR_SERVICIO_DISTANCIA ,CIUDAD_SERVICIO 
        FROM SERVICIO A
        INNER JOIN DETALLE_SERVICIO D ON A.ID_SERVICIO = D.ID_SERVICIO
        INNER JOIN GEOGRAFIA E ON A.ID_GEOGRAFIA = E.ID_GEOGRAFIA
        INNER JOIN ESTADO_DE_SERVICIO I ON A.ID_ESTADOSERVICIO = I.ID_ESTADOSERVICIO
        ...
        VALOR_DISTANCIA := VALOR_SERVICIO_DISTANCIA * DISTANCIA_SERVICIO;
        VALOR_TIEMPO := VALOR_SERVICIO_TIEMPO * TIEMPO_SERVICIO;
        
        VALOR_SERVICIO_TOTAL := VALOR_DISTANCIA + VALOR_TIEMPO + TARIFA_BASE1 + VALOR_ADICIONAL;
